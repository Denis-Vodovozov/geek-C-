...
Show2dArray(myArray);
Console.WriteLine();
int minSumRowNumber = (FindMinSumElementsRow(myArray));
Console.WriteLine($"The number of row with minimum sum of elements is {minSumRowNumber}");
*/
...
int[,] Multiply2dArrays(int[,] a, int[,] b)
{
...
Console.WriteLine();
int[,] multiplyArrays = Multiply2dArrays(firstArray, secondArray);
Show2dArray(multiplyArrays);
*/
...
Console.Write("Input size of first dimension: ");
int m = Convert.ToInt32(Console.ReadLine());
Console.Write("Input size of second dimension: ");
int n = Convert.ToInt32(Console.ReadLine());
Console.Write("Input size of third dimension: ");
int b = Convert.ToInt32(Console.ReadLine());
Console.Write("Input min possible value: ");
int min = Convert.ToInt32(Console.ReadLine());
Console.Write("Input max possible value: ");
int max = Convert.ToInt32(Console.ReadLine());
int[,,] uniqueArray = MakeNumbersUnique(m, n, b, min, max);
